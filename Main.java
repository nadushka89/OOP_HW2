...
public class Main {
    ...
    private static void menu(Zoo animals, Scanner input) {
        ...
        System.out.println("2. Удаление животноого из зоопарка. ");
    ...
    private static void addAnimal(Zoo animals, Scanner input) {
        System.out.println("1. Добавить кота/кошку. ");
        System.out.println("2. Добавить собаку. ");
        System.out.println("3. Добавить курицу. ");
        System.out.println("4. Добавить аиста. ");
        System.out.println("5. Добавить тигра. ");
        System.out.println("6. Добавить волка. ");
        System.out.println("7. Назад в главное меню. ");
        System.out.println("---");
        System.out.println();
        System.out.println("Выберите необходимый пункт в меню: ");
        int answer = input.nextInt();
    ...
    private static void removeAnimal(Zoo animal, Scanner input) {
        animal.showAll();
        System.out.printf("%d) Назад\n", (Zoo.allAnimal.size() + 1));
        System.out.println("Выберите цифру для удаления: ");
        int answer = input.nextInt();
        if (answer <= Zoo.allAnimal.size()) {
            animal.removeAnimal(answer - 1);
    ...
    private static void infoAnimal(Zoo animal, Scanner input) {
        animal.showAll();
        System.out.printf("%d) Назад\n", (Zoo.allAnimal.size() + 1));
        System.out.println("Выберите цифру для просмотра: ");
        int answer = input.nextInt();
        if (answer <= Zoo.allAnimal.size()) {
            animal.animalInfo(answer-1);
            System.out.println("");
            animal.showAnimal(answer-1);
            System.out.println("---");
    ...
    private static void sayAnimal(Zoo animal, Scanner input) {
        animal.showAll();
        System.out.printf("%d) Назад\n", (Zoo.allAnimal.size() + 1));
        System.out.println("Выберите цифру кому произнести звук: ");
        int answer = input.nextInt();
        if (answer <= Zoo.allAnimal.size()) {
            animal.animalSound(answer - 1);
            System.out.println("---");
